  ...
  return (
    <div className='min-h-screen from-gray-900 via-gray-800 to-gray-900 flex items-center justify-center px-4'>
      <div className='text-center max-w-md'>
        ...
        <Link 
          to='/' 
          className='inline-block from-blue-500 to-blue-600 hover:from-blue-600 hover:to-blue-700 text-white font-semibold py-3 px-8 rounded-lg transition duration-200 shadow-lg'
        >
          Back to Home
        </Link>
      </div>
